...
TK_LIBS='-lX11 -lXft -lX11 -lfreetype -lfontconfig -lXrender -lX11  -ldl  -lieee -lm'

# Top-level directory in which Tk's platform-independent files are
# installed.
TK_PREFIX='/home/oide/SAD/oldsad/arch/i386-Linux2'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/home/oide/SAD/oldsad/arch/i386-Linux2'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/home/oide/SAD/oldsad/obj/i386-Linux2/tk8.5.8/unix -ltk8.5'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/home/oide/SAD/oldsad/arch/i386-Linux2/lib -ltk8.5'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/home/oide/SAD/oldsad/arch/i386-Linux2/include'
...
# compiled.
TK_SRC_DIR='/home/oide/SAD/oldsad/obj/i386-Linux2/tk8.5.8'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/home/oide/SAD/oldsad/obj/i386-Linux2/tk8.5.8/unix -ltkstub8.5'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/home/oide/SAD/oldsad/arch/i386-Linux2/lib -ltkstub8.5'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/home/oide/SAD/oldsad/obj/i386-Linux2/tk8.5.8/unix/libtkstub8.5.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/home/oide/SAD/oldsad/arch/i386-Linux2/lib/libtkstub8.5.a'
