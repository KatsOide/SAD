...
c
     ...
     $     p_NDIV_BEND=p_ANGLGEO_BEND+1,
     $     p_NPARAM_BEND=p_NDIV_BEND-ky_MAX_BEND,
c  for quad
     $ky_L_QUAD=1,
     $ky_K1_QUAD=2,
c     ky_DK1_QUAD=3,
...
c     $     p_SINTHETA_QUAD=p_COSTHETA_QUAD+1,
     ...
     $     p_NDIV_QUAD=p_FRMD_QUAD+1,
     $     p_NPARAM_QUAD=p_NDIV_QUAD-ky_MAX_QUAD,
c  for THIN
     $ky_L_THIN=1,
     $ky_K_THIN=2,
     $ky_ROT_THIN=4,
...
c
     ...
     $     p_NDIV_THIN=p_THETA_THIN+1,
     $     p_NPARAM_THIN=p_NDIV_THIN-ky_MAX_THIN,
c  for MULT
     $ky_L_MULT=1,
     $ky_DX_MULT=3,
     $ky_DY_MULT=4,
...
c
     ...
     $     p_NDIV_MULT=p_PROF_MULT+1,
     $     p_NPARAM_MULT=p_NDIV_MULT-ky_MAX_MULT,
c  for UNDULATOR
     $ky_L_UND=1,
     $ky_FBX_UND=2,
     $ky_FBY_UND=3,
...
c
     ...
     $     p_NDIV_CAVI=p_FRMD_CAVI+1,
     $     p_NPARAM_CAVI=p_NDIV_CAVI-ky_MAX_CAVI,
cc for t-Cavity
     $ky_L_TCAV=1,
     $ky_K0_TCAV=2,
     $ky_HARM_TCAV=3,
