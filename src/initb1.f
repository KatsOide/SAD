...
cc for MARK
      ...
      kytbl(kwAZ      ,icMark)=22
      kytbl(kwBZ      ,icMark)=23
      kytbl(kwPZ      ,icMark)=24
      kytbl(kwZX      ,icMark)=25
      kytbl(kwZPX     ,icMark)=26
      kytbl(kwZY      ,icMark)=27
      kytbl(kwZPY     ,icMark)=28
      kytbl(kwDP      ,icMark)=29
      kytbl(kwOFFSET  ,icMark)=30
      kytbl(kwSIGZ    ,icMark)=31
      kytbl(kwGEO     ,icMark)=32
      kytbl(kwJDX     ,icMark)=33
      kytbl(kwJDPX    ,icMark)=34
      kytbl(kwJDY     ,icMark)=35
      kytbl(kwJDPY    ,icMark)=36
      kytbl(kwJDZ     ,icMark)=37
      kytbl(kwJDPZ    ,icMark)=38
      kytbl(kwEMIX    ,icMark)=39
      kytbl(kwEMIY    ,icMark)=40
      kytbl(kwCOUPLE  ,icMark)=41
      kytbl(kwMAX     ,icMark)=42
cc for apert
