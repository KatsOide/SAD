     ...
     $     du11,du12,du21,du22,dv11,dv12,dv21,dv22,
...
c      endif
      ...
      sr44 = c1
      tm11 =  sr11*(u11*s11)
     1     +sr13*(v11*s31 + v12*s41)
     1     +sr14*(v21*s31 + v22*s41)
      tm12 =  sr11*(u12*s22)
     1     +sr13*(v11*s32 + v12*s42)
     1     +sr14*(v21*s32 + v22*s42)
      tm13 =  sr11*(u11*s13 + u12*s23)
     1     +sr13*(v11*s33)
     1     +sr14*(v21*s33)
      tm14 =  sr11*(u11*s14 + u12*s24)
     1     +sr13*(v12*s44)
     1     +sr14*(v22*s44)
      tm21 =  
     1     +sr22*(u21*s11)
     1     +sr23*(v11*s31 + v12*s41)
     1     +sr24*(v21*s31 + v22*s41)
      tm22 =  
     1     +sr22*(u22*s22)
     1     +sr23*(v11*s32 + v12*s42)
     1     +sr24*(v21*s32 + v22*s42)
      tm23 =  
     1     +sr22*(u21*s13 + u22*s23)
     1     +sr23*(v11*s33)
     1     +sr24*(v21*s33)
      tm24 =  
     1     +sr22*(u21*s14 + u22*s24)
     1     +sr23*(v12*s44)
     1     +sr24*(v22*s44)
      tm31 =  sr31*(u11*s11)
     1     +sr32*(u21*s11)
     1     +sr33*(v11*s31 + v12*s41)
      tm32 =  sr31*(u12*s22)
     1     +sr32*(u22*s22)
     1     +sr33*(v11*s32 + v12*s42)
      tm33 =  sr31*(u11*s13 + u12*s23)
     1     +sr32*(u21*s13 + u22*s23)
     1     +sr33*(v11*s33)
      tm34 =  sr31*(u11*s14 + u12*s24)
     1     +sr32*(u21*s14 + u22*s24)
     1     +sr33*(v12*s44)
      tm41 =  sr41*(u11*s11)
     1     +sr42*(u21*s11)
     1     +sr44*(v21*s31 + v22*s41)
      tm42 =  sr41*(u12*s22)
     1     +sr42*(u22*s22)
     1     +sr44*(v21*s32 + v22*s42)
      tm43 =  sr41*(u11*s13 + u12*s23)
     1     +sr42*(u21*s13 + u22*s23)
     1     +sr44*(v21*s33)
      tm44 =  sr41*(u11*s14 + u12*s24)
     1     +sr42*(u21*s14 + u22*s24)
     1     +sr44*(v22*s44)
...
c     c^2+Det(R)=1   ---> dc = - d(Det(R))/(2c)
     ...
     1       -dr12*r21 - dr21*r12
      ...
      dsr43 = 0.d0
      dsr44 = dc1
      dtm11 =  dsr11*(u11*s11)+sr11*(du11*s11)
     1     +dsr13*(v11*s31 + v12*s41)+sr13*(dv11*s31 + dv12*s41)
     1     +dsr14*(v21*s31 + v22*s41)+sr14*(dv21*s31 + dv22*s41)
      dtm12 =  dsr11*(u12*s22)+sr11*(du12*s22)
     1     +dsr13*(v11*s32 + v12*s42)+sr13*(dv11*s32 + dv12*s42)
     1     +dsr14*(v21*s32 + v22*s42)+sr14*(dv21*s32 + dv22*s42)
      dtm13 =  dsr11*(u11*s13 + u12*s23)+sr11*(du11*s13 + du12*s23)
     1     +dsr13*(v11*s33)+sr13*(dv11*s33)
     1     +dsr14*(v21*s33)+sr14*(dv21*s33)
      dtm14 =  dsr11*(u11*s14 + u12*s24)+sr11*(du11*s14 + du12*s24)
     1     +dsr13*(v12*s44)+sr13*(dv12*s44)
     1     +dsr14*(v22*s44)+sr14*(dv22*s44)
      dtm21 =  
     1     +dsr22*(u21*s11)+sr22*(du21*s11)
     1     +dsr23*(v11*s31 + v12*s41)+sr23*(dv11*s31 + dv12*s41)
     1     +dsr24*(v21*s31 + v22*s41)+sr24*(dv21*s31 + dv22*s41)
      dtm22 =  
     1     +dsr22*(u22*s22)+sr22*(du22*s22)
     1     +dsr23*(v11*s32 + v12*s42)+sr23*(dv11*s32 + dv12*s42)
     1     +dsr24*(v21*s32 + v22*s42)+sr24*(dv21*s32 + dv22*s42)
      dtm23 =  
     1     +dsr22*(u21*s13 + u22*s23)+sr22*(du21*s13 + du22*s23)
     1     +dsr23*(v11*s33)+sr23*(dv11*s33 )
     1     +dsr24*(v21*s33)+sr24*(dv21*s33 )
      dtm24 =  
     1     +dsr22*(u21*s14 + u22*s24)+sr22*(du21*s14 + du22*s24)
     1     +dsr23*(v12*s44)+sr23*(dv12*s44)
     1     +dsr24*(v22*s44)+sr24*(dv22*s44)
      dtm31 =  dsr31*(u11*s11)+sr31*(du11*s11)
     1     +dsr32*(u21*s11)+sr32*(du21*s11)
     1     +dsr33*(v11*s31 + v12*s41)+sr33*(dv11*s31 + dv12*s41)
      dtm32 =  dsr31*(u12*s22)+sr31*(du12*s22)
     1     +dsr32*(u22*s22)+sr32*(du22*s22)
     1     +dsr33*(v11*s32 + v12*s42)+sr33*(dv11*s32 + dv12*s42)
      dtm33 =  dsr31*(u11*s13 + u12*s23)+sr31*(du11*s13 + du12*s23)
     1     +dsr32*(u21*s13 + u22*s23)+sr32*(du21*s13 + du22*s23)
     1     +dsr33*(v11*s33 )+sr33*(dv11*s33 )
      dtm34 =  dsr31*(u11*s14 + u12*s24)+sr31*(du11*s14 + du12*s24)
     1     +dsr32*(u21*s14 + u22*s24)+sr32*(du21*s14 + du22*s24)
     1     +dsr33*(v12*s44)+sr33*(dv12*s44)
      dtm41 =  dsr41*(u11*s11)+sr41*(du11*s11)
     1     +dsr42*(u21*s11)+sr42*(du21*s11)
     1     +dsr44*(v21*s31 + v22*s41)+sr44*(dv21*s31 + dv22*s41)
      dtm42 =  dsr41*(u12*s22)+sr41*(du12*s22)
     1     +dsr42*(u22*s22)+sr42*(du22*s22)
     1     +dsr44*(v21*s32 + v22*s42)+sr44*(dv21*s32 + dv22*s42)
      dtm43 =  dsr41*(u11*s13 + u12*s23)+sr41*(du11*s13 + du12*s23)
     1     +dsr42*(u21*s13 + u22*s23)+sr42*(du21*s13 + du22*s23)
     1     +dsr44*(v21*s33 )+sr44*(dv21*s33 )
      dtm44 =  dsr41*(u11*s14 + u12*s24)+sr41*(du11*s14 + du12*s24)
     1     +dsr42*(u21*s14 + u22*s24)+sr42*(du21*s14 + du22*s24)
     1     +dsr44*(v22*s44)+sr44*(dv22*s44)
...
c          -------------------------------
      ...
      dtwiss(mfitr3) = dr3
      dtwiss(mfitr4) = dr4
      write(*,'(a,1p6g15.7)')'qdcell-dr ',dr1,dr2,dr3,dr4,detr,ddetr
