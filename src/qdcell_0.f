...
c          -------------------------------
      ...
      dtwiss(mfitr3) = dr3
      dtwiss(mfitr4) = dr4
      write(*,'(a,1p6g15.7)')'qdcell ',dr1,dr2,dr3,dr4,detr,ddetr
...
C------dA,dB:derivative of diagonalized transfer matrix ------
         da11 = ds11*(tm11*s11+tm12*s21-tm13*s31-tm14*s41)
     1        + ds12*(tm21*s11+tm22*s21-tm23*s31-tm24*s41)
     1        + ds13*(tm31*s11+tm32*s21-tm33*s31-tm34*s41)
     1        + ds14*(tm41*s11+tm42*s21-tm43*s31-tm44*s41)
     1        + s11*(dtm11*s11+dtm12*s21-dtm13*s31-dtm14*s41)
     1        + s12*(dtm21*s11+dtm22*s21-dtm23*s31-dtm24*s41)
     1        + s13*(dtm31*s11+dtm32*s21-dtm33*s31-dtm34*s41)
     1        + s14*(dtm41*s11+dtm42*s21-dtm43*s31-dtm44*s41)
     1        + s11*(tm11*ds11+tm12*ds21-tm13*ds31-tm14*ds41)
     1        + s12*(tm21*ds11+tm22*ds21-tm23*ds31-tm24*ds41)
     1        + s13*(tm31*ds11+tm32*ds21-tm33*ds31-tm34*ds41)
     1        + s14*(tm41*ds11+tm42*ds21-tm43*ds31-tm44*ds41)
         da12 = ds11*(tm11*s12+tm12*s22-tm13*s32-tm14*s42)
     1        + ds12*(tm21*s12+tm22*s22-tm23*s32-tm24*s42)
     1        + ds13*(tm31*s12+tm32*s22-tm33*s32-tm34*s42)
     1        + ds14*(tm41*s12+tm42*s22-tm43*s32-tm44*s42)
     1        + s11*(dtm11*s12+dtm12*s22-dtm13*s32-dtm14*s42)
     1        + s12*(dtm21*s12+dtm22*s22-dtm23*s32-dtm24*s42)
     1        + s13*(dtm31*s12+dtm32*s22-dtm33*s32-dtm34*s42)
     1        + s14*(dtm41*s12+dtm42*s22-dtm43*s32-dtm44*s42)
     1        + s11*(tm11*ds12+tm12*ds22-tm13*ds32-tm14*ds42)
     1        + s12*(tm21*ds12+tm22*ds22-tm23*ds32-tm24*ds42)
     1        + s13*(tm31*ds12+tm32*ds22-tm33*ds32-tm34*ds42)
     1        + s14*(tm41*ds12+tm42*ds22-tm43*ds32-tm44*ds42)
         da21 = ds21*(tm11*s11+tm12*s21-tm13*s31-tm14*s41)
     ...
     1        + s21*(dtm11*s11+dtm12*s21-dtm13*s31-dtm14*s41)
     ...
     1        + s21*(tm11*ds11+tm12*ds21-tm13*ds31-tm14*ds41)
     ...
     1        + s24*(tm41*ds11+tm42*ds21-tm43*ds31-tm44*ds41)
         da22 = ds21*(tm11*s12+tm12*s22-tm13*s32-tm14*s42)
     1        + ds22*(tm21*s12+tm22*s22-tm23*s32-tm24*s42)
     1        + ds23*(tm31*s12+tm32*s22-tm33*s32-tm34*s42)
     1        + ds24*(tm41*s12+tm42*s22-tm43*s32-tm44*s42)
     1        + s21*(dtm11*s12+dtm12*s22-dtm13*s32-dtm14*s42)
     1        + s22*(dtm21*s12+dtm22*s22-dtm23*s32-dtm24*s42)
     1        + s23*(dtm31*s12+dtm32*s22-dtm33*s32-dtm34*s42)
     1        + s24*(dtm41*s12+dtm42*s22-dtm43*s32-dtm44*s42)
     1        + s21*(tm11*ds12+tm12*ds22-tm13*ds32-tm14*ds42)
     1        + s22*(tm21*ds12+tm22*ds22-tm23*ds32-tm24*ds42)
     1        + s23*(tm31*ds12+tm32*ds22-tm33*ds32-tm34*ds42)
     1        + s24*(tm41*ds12+tm42*ds22-tm43*ds32-tm44*ds42)
         db11 = ds31*(-tm11*s13-tm12*s23+tm13*s33+tm14*s43)
     1        + ds32*(-tm21*s13-tm22*s23+tm23*s33+tm24*s43)
     1        + ds33*(-tm31*s13-tm32*s23+tm33*s33+tm34*s43)
     1        + ds34*(-tm41*s13-tm42*s23+tm43*s33+tm44*s43)
     1        + s31*(-dtm11*s13-dtm12*s23+dtm13*s33+dtm14*s43)
     1        + s32*(-dtm21*s13-dtm22*s23+dtm23*s33+dtm24*s43)
     1        + s33*(-dtm31*s13-dtm32*s23+dtm33*s33+dtm34*s43)
     1        + s34*(-dtm41*s13-dtm42*s23+dtm43*s33+dtm44*s43)
     1        + s31*(-tm11*ds13-tm12*ds23+tm13*ds33+tm14*ds43)
     1        + s32*(-tm21*ds13-tm22*ds23+tm23*ds33+tm24*ds43)
     1        + s33*(-tm31*ds13-tm32*ds23+tm33*ds33+tm34*ds43)
     1        + s34*(-tm41*ds13-tm42*ds23+tm43*ds33+tm44*ds43)
         db12 = ds31*(-tm11*s14-tm12*s24+tm13*s34+tm14*s44)
     1        + ds32*(-tm21*s14-tm22*s24+tm23*s34+tm24*s44)
     1        + ds33*(-tm31*s14-tm32*s24+tm33*s34+tm34*s44)
     1        + ds34*(-tm41*s14-tm42*s24+tm43*s34+tm44*s44)
     1        + s31*(-dtm11*s14-dtm12*s24+dtm13*s34+dtm14*s44)
     1        + s32*(-dtm21*s14-dtm22*s24+dtm23*s34+dtm24*s44)
     1        + s33*(-dtm31*s14-dtm32*s24+dtm33*s34+dtm34*s44)
     1        + s34*(-dtm41*s14-dtm42*s24+dtm43*s34+dtm44*s44)
     1        + s31*(-tm11*ds14-tm12*ds24+tm13*ds34+tm14*ds44)
     1        + s32*(-tm21*ds14-tm22*ds24+tm23*ds34+tm24*ds44)
     1        + s33*(-tm31*ds14-tm32*ds24+tm33*ds34+tm34*ds44)
     1        + s34*(-tm41*ds14-tm42*ds24+tm43*ds34+tm44*ds44)
         db21 = ds41*(-tm11*s13-tm12*s23+tm13*s33+tm14*s43)
     1        + ds42*(-tm21*s13-tm22*s23+tm23*s33+tm24*s43)
     1        + ds43*(-tm31*s13-tm32*s23+tm33*s33+tm34*s43)
     1        + ds44*(-tm41*s13-tm42*s23+tm43*s33+tm44*s43)
     1        + s41*(-dtm11*s13-dtm12*s23+dtm13*s33+dtm14*s43)
     1        + s42*(-dtm21*s13-dtm22*s23+dtm23*s33+dtm24*s43)
     1        + s43*(-dtm31*s13-dtm32*s23+dtm33*s33+dtm34*s43)
     1        + s44*(-dtm41*s13-dtm42*s23+dtm43*s33+dtm44*s43)
     1        + s41*(-tm11*ds13-tm12*ds23+tm13*ds33+tm14*ds43)
     1        + s42*(-tm21*ds13-tm22*ds23+tm23*ds33+tm24*ds43)
     1        + s43*(-tm31*ds13-tm32*ds23+tm33*ds33+tm34*ds43)
     1        + s44*(-tm41*ds13-tm42*ds23+tm43*ds33+tm44*ds43)
         db22 = ds41*(-tm11*s14-tm12*s24+tm13*s34+tm14*s44)
     1        + ds42*(-tm21*s14-tm22*s24+tm23*s34+tm24*s44)
     1        + ds43*(-tm31*s14-tm32*s24+tm33*s34+tm34*s44)
     1        + ds44*(-tm41*s14-tm42*s24+tm43*s34+tm44*s44)
     1        + s41*(-dtm11*s14-dtm12*s24+dtm13*s34+dtm14*s44)
     1        + s42*(-dtm21*s14-dtm22*s24+dtm23*s34+dtm24*s44)
     1        + s43*(-dtm31*s14-dtm32*s24+dtm33*s34+dtm34*s44)
     1        + s44*(-dtm41*s14-dtm42*s24+dtm43*s34+dtm44*s44)
     1        + s41*(-tm11*ds14-tm12*ds24+tm13*ds34+tm14*ds44)
     1        + s42*(-tm21*ds14-tm22*ds24+tm23*ds34+tm24*ds44)
     1        + s43*(-tm31*ds14-tm32*ds24+tm33*ds34+tm34*ds44)
     1        + s44*(-tm41*ds14-tm42*ds24+tm43*ds34+tm44*ds44)
c-deb
