...
#define DEF_BUTTON_ALTFONT "-adobe-symbol-medium-r-normal--*-140-*-*-*-*-*-*"
#define DEF_BUTTON_SCRFONT "-adobe-helvetica-bold-r-normal--*-80-*-*-*-*-*-*"
#define DEF_BUTTON_ALTSCRFONT "-adobe-symbol-medium-r-normal--*-100-*-*-*-*-*-*"
