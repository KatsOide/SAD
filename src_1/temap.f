...
c        call tfdebugprint(kx,'temap',1)
 ...
 9000 levele=itfdownlevel()
     ...
     $     ktfmalocp,ka1,kat1,kbm,krt,isp0
      integer*4 l,itfdownlevel,n,m,irtc,i,j,ia
 ...
 9100 levele=itfdownlevel()
     ...
     $     '{cod(6), trans(6,6), dtrans(6,6), dbeam(6,6)}.'
      ...
      use tmacro
      implicit none
      integer*8 ktfmalocp, k1,k2,kx,kax,kat1,ka1,isp0
      integer*4 l,itfdownlevel,n,m,irtc
...
c      itastk(2,isp)=iat
 ...
 9100 write(*,*)'ExternalMap(OPTICS) of ',l,ord(l),
     ...
     $     '{cod(6), trans(6,6)}.'
      ...
      use tmacro
      implicit none
      integer*8 ktfgeol,kx,kax,
     $     k1,k2,k11,k12,ka1,ka11,ka12,kdb,isp0
      integer*4 l,irtc,itfdownlevel
      real*8 rfromk
      character*2 ord
      logical*4 err
      integer*8 ifv,iem
