      ...
      integer*8 isp1,isp0,i,j,isp2
      integer*4 irtc,ir,ls,imin,ii,nr,indexb,itfmessage
      logical*4 full
 ...
 9000 call tfreestringbuf(strb)
      ...
      integer*8 isp1,isp0
      integer*4 irtc,n1,n2,m,n,itfmessage,na
      logical*4 full
     ...
     $       '"[String, String, Real]"')
      ...
      integer*8 isp1
      integer*4 irtc,i,i1,i2,nc,itfmessage
 ...
 10   kx=kxstringbuftostring(strb)
      ...
      type (sad_string), pointer :: str
      integer*8 ka,ic,i,isp1,isp0
      integer*4 irtc,nc1,narg,itfmessage
      character*32 form
...
c      include 'DEBUG.inc'
     ...
     $         itfcontextpath+ilist(2,itfcontextpath-1)-1
      ...
      type (sad_string), pointer :: str
      integer*8 isp1
      integer*4 narg,irtc,i,m,itfmessage
      narg=int(isp-isp1)
      if(narg .ne. 1)then
        irtc=itfmessage(9,'General::narg','"1"')
        return
     ...
     $       '"Real or List of Reals"')
      ...
      integer*8 isp1
      integer*4 irtc,nc,nc1,itfmessage
      logical*4 tmatchl
      if(isp .ne. isp1+2)then
        irtc=itfmessage(9,'General::narg','"2"')
        return
     ...
     $       '"[String, Pattern-string]"')
      ...
      integer*8 isp1,isp0,j,i
      integer*4 irtc,nc,nc1,i1,ip,l,itfmessage,indexb
 ...
 100  kx=kxadaloc(-1,int(isp-isp0),klx)
      do i=isp0+1,isp
      ...
      integer*8 isp1
      integer*4 irtc,nc,mode,itfmessage,i,kk
      logical*4 rep
      integer*1 jdif
