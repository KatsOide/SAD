      ...
      integer*8 isp0,isp1,i
      integer*4 iprior(0:mtfnopc),irtc
      integer*4 iop,iop1,itgetfpe,itfmessage
...
c      include 'DEBUG.inc'
     ...
     $           ktfrealqd(dtastk(isp)))then
      ...
      kx=kxcrelistm(int(isp-isp1),ktastk(isp1+1:isp),kh)
      irtc=0
      return
      end
 ...
 10   kx=kxcrelistm(int(isp-isp1),ktastk(isp1+1:isp),kh)
      irtc=0
      return
      end
      ...
      type (sad_descriptor) kx
      type (sad_list), pointer :: klx
      integer*8 iee0,isp1,isp0,isp00,i
      integer*4 iah,irtc,iy,iv
...
c          write(*,*)'with ',irtc
 ...
 110  irtc=0
      ...
      implicit none
      type (sad_descriptor) kx
      integer*8 ka,kti,kai,i,isp1
      integer*4 iah,irtc,narg,id
      real*8 rimmediate0
