...
static int DecodeOption(integer8 *isp1, integer4 *irtc, sad_date_option_t *opt,
...
static int DateCommand(integer8 *isp1,
		       integer8 *kx,
...
static int GetTimeOfDay(integer8 *isp1,
			integer8 *kx,
			integer4 *irtc) {
  struct taia now;
  tai_t t;
