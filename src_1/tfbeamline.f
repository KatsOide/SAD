 ...
 9900 irtc=itfmessage(9,'General::wrongtype','"BeamLine[ ... ]"')
      ...
      integer*8 ktaloc,idx1,idxm1,idxd1
      ...
      include 'inc/MACCODE.inc'
      include 'inc/MACKW.inc'
      integer*8 ka1,kas,idx1,ktaloc,isp1,isp0
      integer*4 irtc,nc,lenw,narg,idx,itype,
     $     idt,n,i,nce,m,hsrchz,itfmessage
...
c      write(*,*)'tfsetelement ',ename,itype,idx,icNULL
 ...
 10       kv=kl%body(2)
     ...
     $     ktastk(isp) .ne. ktfoper+mtfnull)then
      ...
      integer*8 itfilattp,idx,isp1
      integer*4 irtc,lenw,i,n,hsrchz,idl,nc,itfmessage
     ...
     $           '"'//ename(1:lenw(ename))//'"')
      ...
      do i=1,n
        ename=pname(ilist(2,klist(idx+i)))
        if(rlist(klist(idx+i)+ilist(1,klist(idx+i))) .ge. 0.d0)then
      ...
      integer*8 kal
      integer*4 irtc,j,k,m,n
      integer*8 ifbeamline,isp1,isp2,i,isp0
      data ifbeamline/0/
