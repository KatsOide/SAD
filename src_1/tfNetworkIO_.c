...
static int tfSocketOpen(integer8 *isp1,
			integer8 *kx,
			integer4 *irtc, int socktype) {
  integer8 ia1, ia2, iax, ispi;
  integer4 in1, in2;
  real8 vx, timeout;
  int fd1, fd2, fdn, err;
  int port0 = 0, port = 0;
...
static int tfHostName(integer8 *isp1,
		      integer8 *kx,
		      integer4 *irtc) {
...
static int tfGetHostAddrByName(integer8 *isp1,
			       integer8 *kx,
			       integer4 *irtc) {
  integer8 ia, kax;
...
static int tfGetHostNameByAddr(integer8 *isp1,
			       integer8 *kx,
			       integer4 *irtc) {
  integer4 ia;
  int err;
...
static int tfTCPOpen(integer8 *isp1,
		     integer8 *kx,
		     integer4 *irtc) {
  return tfSocketOpen(isp1, kx, irtc, SOCK_STREAM);
}

static int tfUDPOpen(integer8 *isp1,
		     integer8 *kx,
		     integer4 *irtc) {
  return tfSocketOpen(isp1, kx, irtc, SOCK_DGRAM);
}

static int tfTCPAccept(integer8 *isp1,
		       integer8 *kx,
		       integer4 *irtc) {
  integer8 kax;
...
static int tfSelectUnit(integer8 *isp1,
			integer8 *kx,
			integer4 *irtc) {
  integer8 kax, ia, ki;
  integer4 inr;
