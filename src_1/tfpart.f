      ...
      integer*8 isp1,isp0,isp2
      integer*4 irtc,narg,ivi,iv,ma,m,i,itfmessage,itfmessageexp
      logical*4 err
      narg=int(isp2-isp1)
      ma=list%nl
      kl=dtastk(isp1+1)
 ...
 9040 if(err)then
      ...
      type (sad_list), pointer :: kl
      integer*8 isp1
      integer*4 irtc,itfmessage,mode,m
      ...
      integer*8 isp1,isp0
      integer*4 irtc,narg,i,itfmessage,m
      narg=int(isp-isp1)
      if(narg .eq. 2)then
        kh%k=ktfref
 ...
 9000 isp=isp0
      ...
      integer*4 irtc
      integer*8 isp0,isp1,isp2,isp3,i
      logical*4 list,eval
      isp1=isp
...
c        enddo
      ...
      integer*8 isp1
      integer*4 irtc,narg,i,mode,itfmessage
 ...
 9000 if(mode .eq. 1)then
      ...
      integer*8 isp0,isp2,isp3,i
      integer*4 mode,irtc,ivi,itfmessage
 ...
 9000 isp=isp0
      ...
      integer*8 isp1
      integer*4 irtc,narg,i,m,id,itfmessage
      real*8 vp,vs
      narg=int(isp-isp1)
      k=dtastk(isp1+1)
      if(ktfnonlistqd(k,kl))then
     ...
     $       '"Real or List of Reals for index"')
      ...
      integer*8 kai,isp10,isp20,isp2,isp3,isp0,isp1
      integer*4 ma,ne,no,i,mp,irtc,j,itfmessage
      data kxthread%k /0/
     ...
     $       '"#2","positive number or list of them"')
      ...
      integer*8 kai,isp1,isp0,isp2,isp3
      integer*4 irtc,narg,mode,
     $     i,j,n,m,itfmessage
 ...
 1000 if(mode .ne. 2)then
      ...
      integer*8 kap,isp1,isp2,i
      integer*4 irtc,n,itfmessageexp,mode
