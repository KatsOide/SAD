      ...
      integer*4 irtc,neq,nvar,itfmessage,i,maxi
...
c      enddo
 ...
 9000 l=itfdownlevel()
     ...
     $     nvar,sav,sav0,v0,vmin,vmax,nvmax,irtc)
      ...
      integer*4 nvar,nvmax,j,irtc,ig,itfmessage
      type (symv) sav(nvmax),sav0(nvmax)
      real*8 v0(nvmax),vmin(nvmax),vmax(nvmax)
      nvar=int(isp2-isp1+1)
...
c        call tfstk2l(lista,list)
 ...
 9000 irtc=itfmessage(9,'General::wrongtype',
     $     '"f == g or List of them"')
      ...
      integer*4 nvar,maxi,n,m,iu,ig,itfmessage
      type (symv) sav(nvmax),sav0(nvmax)
      integer*8 kdl(nvmax),kdp,kci,kcv,ktfmaloc,isp1,ispv,isp2,i
...
c            enddo
 ...
 9000 l=itfdownlevel()
      ...
      integer*4 nvar,irtc,i
      type (symv) sav(nvar)
      integer*8 kdl(nvar),kr,ks,ierr0,isp0
      logical*4 euv
