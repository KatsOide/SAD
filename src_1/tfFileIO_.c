...
static int ExpandTilde(integer8 *isp1,
		       integer8 *kx,
		       integer4 *irtc) {
  integer8 ia;
  char *expanded;
...
static int FromFileDate(integer8 *isp1,
			integer8 *kx,
			integer4 *irtc) {
  integer8 ia;
  real8 vx;
...
static int ReadLink(integer8 *isp1,
		    integer8 *kx,
		    integer4 *irtc) {
  integer8 ia;
  integer4 nc;
...
static int RealPath(integer8 *isp1,
		    integer8 *kx,
		    integer4 *irtc) {
  integer8 ia;
...
static int MkSecureTemp(integer8 *isp1,
			integer8 *kx,
			integer4 *irtc) {
  integer8 ka1, ka2 = 0;
  int fd, nc, slen;
...
static int Pipe(integer8 *isp1, integer8 *kx,
		integer4 *irtc) {
  integer8 isp0;
  integer4 luns[2];
  int fildes[2];
...
static int SetLUN2FD(integer8 *isp1, integer8 *kx,
		     integer4 *irtc) {
  integer4 lun;
  int fd;
