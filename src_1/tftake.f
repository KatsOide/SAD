 ...
 1    klx%head=ktfcopy(kl%head)
      ...
      integer*8 isp1
      integer*4 irtc,i,m,itfmessage,n
...
c      include 'DEBUG.inc'
      integer*8 kad,kad1,kadi,kadi1,isp0
      integer*4 irtc,ik,i
     ...
     $     iaxprotected,iaxnumeric
      ...
      type (sad_descriptor) kx,k
      type (sad_symbol), pointer :: sym
      integer*8 ka,isp1,isp0
      integer*4 iat,irtc,itfmessage
      ...
      type (sad_symbol), pointer :: sym
      integer*8 ka,isp1,isp0
      integer*4 irtc,narg,iattrib,i,itfmessage,itfmessageexp
 ...
 9100 irtc=itfmessageexp(999,'General::protect',k)
      ...
      integer*8 isp1,i,isp0,isp2,isp3,isp4,j
      integer*4 irtc
      if(isp .le. isp1)then
        irtc=0
        return
