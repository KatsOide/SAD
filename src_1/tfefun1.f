      ...
      integer*8 ka,isp1,ispi
      integer*4 id,irtc,na,i,m,j,narg,id0,itfmessage,l
      real*8 rgetgl1
      logical*4 ref
      irtc=-1
      id=id0-1000
...
c            SetE PyAg TclA Tcl  ClLi ExpB GetM ClTr LiTr RGBC
...
c-------Kikuchi addition end-----     
 ...
 5210 call tfsetelement(isp1,kx,irtc)
      return
 5220 irtc=itfmessage(999,'General::unregister',' ')
      return
