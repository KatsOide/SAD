...
integer8 ktfmakelist(integer8 isp1) {
...
void tfdeval(integer8 isp1, integer8 iad,
	     integer8 *kx,
	     integer4 next, 
...
integer4 itfgetoptionstk(integer8 isp1, const char **optv) {
  integer8 *iopt;
