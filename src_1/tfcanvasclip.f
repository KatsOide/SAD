      ...
      integer*8 ka,ka1,ka2,kal,kadash,kaxi,isp1,isp0,isp2,isp3,ispa,i,j
      integer*4 irtc,na,np,n,itfmessage,narg,ndash,k,ignore
...
c        write(*,*)na,isp-isp0
 ...
 9100 irtc=itfmessage(9,'General::wrongtype',
     $     '"{{x1, x2, ..}, {y1, y2, ..}}"')
      ...
      integer*8 ka,kas,kac,kai,kavc,kavs,isp1,isp0,ii
      integer*4 irtc,iav(3),nt,m,itfmessage,j,i
 ...
 100  if(isp1 .lt. isp)then
      ...
      use tfstk
      implicit none
      integer*8 kx,kat,kac,kaci,kaci1,kaci2,isp1,isp0
      integer*4 irtc,itfmessage,nt,nc,i
 ...
 9100 irtc=itfmessage(9,'General::wrongtype',
     $ '"List of light sources: {{{x1, y1, z1}, {r1, g1, b1}}, ...}"')
      ...
      use tfstk
      implicit none
      integer*8 kat,kx,kaci,kati,kati1,kati2,kati3,isp0
      integer*4 nt,nc,irtc,i,j,itfmessage
 ...
 9000 irtc=itfmessage(9,'General::wrongtype',
     ...
     $     tfcanvas3dprojection1(k,e,px,py,d,offset,kx,irtc)
      use tfstk
      implicit none
      integer*8 k,kx,kxi,ki,kax,ka1,kai,ka,kac,kaxi,isp0
      integer*4 irtc,itfmessage,n,i
 ...
 9000 irtc=itfmessage(9,'General::wrongtype',
     $       '"{{x1, y1, z1}, ...} or List of them"')
      ...
      integer*8 ka,kad,kad1,kad2,ks,isp1
      integer*4 irtc,itfmessage
...
c      parameter (a=sqrt(0.75d0))
 ...
 9000 call tfreestringbuf(strb)
     ...
     $     kavx,kavy,ktrsaloc,ka2,isp1,isp0
