      ...
      integer*8 kz,kzp,kpz,ktaloc,kzf,isp1,
     $     kaxl,ktfmalocp,ktfresetparticles
      integer*4 irtc,narg,itfloc,outfl0,ld,ls,mc,npz,npa,np00,
...
c        endif
 ...
 9100 irtc=itfmessage(9,'General::wrongval',
     $     '"[nbegin [, nend]] for #3 and #4"')
      ...
      integer*8 isp1
      integer*4 irtc,npx,i,j,itfmessage,np,ii
