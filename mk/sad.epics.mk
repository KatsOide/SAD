...
#EPICS_IOPT=-I$(EPICS_INCDIR) -I$(EPICS_INCDIR)/compiler/$(CC)/ -I$(EPICS_INCDIR)/compiler/clang/ -I$(EPICS_INCDIR)/os/$(EPICS_OS_CLASS)
EPICS_IOPT=-I$(EPICS_INCDIR) -I$(EPICS_INCDIR)/compiler/$(CC)/ -I$(EPICS_INCDIR)/os/$(EPICS_OS_CLASS)
