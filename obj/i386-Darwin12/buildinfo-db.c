...
const buildinfo_t buildinfo_db[] = {
  ...
  {"Target:OS_MAJOR",	_INT, 12, NULL},
  {"Target:OS_MINOR",	_INT, 5, NULL},
  {"Target:OS_RELEASE",	_STR, 0, "12.5.0"},
  {"Target:CPU_ARCH",	_STR, 0, "i386"},
  {"Target:MACH_ARCH",	_STR, 0, "i386-Darwin12"},
  ...
  {"Built:Location",	_STR, 0, "oide@mar89-106.kek.jp:/Users/oide/SAD/oldsad/obj/i386-Darwin12"},
  {"Built:Date",	_STR, 0, "2013-10-21 09:28:07 +0900"},
  {NULL,	_NOP, 0, NULL}};
